...
class _MyServiceRequestState extends State<MyServiceRequest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MyServiceRequestPage(),
    );
  }
}

class MyServiceRequestPage extends StatefulWidget {
  @override
  _MyServiceRequestPageState createState() => _MyServiceRequestPageState();
}

class _MyServiceRequestPageState extends State<MyServiceRequestPage> {
  String heading = "MyServiceRequest Details";
