...
class _BuildingPageState extends State<BuildingPage> {
  ...
  String heading = "Building Details";
  ...
  Column BuildingInfo(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Padding(
          ...
          child: _TextFieldWidgt("Building Name"),
        ),
        Padding(
